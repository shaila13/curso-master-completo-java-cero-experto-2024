...
import org.aguzman.generics.modelo.Cliente;
import org.aguzman.generics.modelo.ClientePremium;
...
public class EjemploGenericos {
    ...
    public static List<Cliente> fromArrayToListCutre(Cliente[] c){
        return Arrays.asList(c);
    }
    public static <T, G> List<T> fromArrayToListACutre(T[] c, G[] x){
        for (G elemento: x){
